    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav pull-right">
                <li class="pull-right"><a href="#">Вход</a></li>
            </ul>
...
<div id="testCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <!-- Слайд 1 -->
        <div class="item ">
            <img style="width: 100%" src="/resources/images/1.jpg" alt="...">
        </div>
        <!-- Слайд 2 -->
        <div class="item active">
            <img style="width: 100%" src="/resources/images/2.jpg" alt="...">
        </div>
        <!-- Слайд 3 -->
        <div class="item">
            <img style="width: 100%" src="/resources/images/3.jpg" alt="...">
        </div>
    </div>
